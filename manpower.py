...
def send_email(receiver_email, subject, body):
    ...
    sender_password = "xkyzpqrstuvwmno"  # Replace with your app-specific password
...
def verify_payment_screenshot(screenshot, transaction_id):
    # In a real application, use OCR (e.g., Google Cloud Vision API) to extract text from the screenshot
    # Here, we'll simulate verification with dummy logic
    our_upi_id = "9731728337@okbizaxis"
    expected_amount = 150
    
    # Simulated extracted data (replace with actual OCR logic)
    extracted_data = {
        "sender_upi": "user@upi",  # Simulated sender UPI
